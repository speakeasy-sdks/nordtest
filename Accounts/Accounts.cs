...
namespace Accounts
{
    ...
    public class Accounts: IAccounts
    {
        ...
        private const string _userAgent = "speakeasy-sdk/csharp 0.3.0 2.194.1 5.0 accounts";
        private string _serverUrl = "";
        private ISpeakeasyHttpClient _defaultClient;
        private ISpeakeasyHttpClient _securityClient;
        public ICustomerAccounts CustomerAccounts { get; private set; }

        public Accounts(Security? security = null, int? serverIndex = null, string? serverUrl = null, Dictionary<string, string>? urlParams = null, ISpeakeasyHttpClient? client = null)
        {
            if (serverUrl != null) {
                if (urlParams != null) {
